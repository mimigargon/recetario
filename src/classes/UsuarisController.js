const APIURL = 'https://app.nocodb.com/api/v2/tables/mcpts9331zvsozj/records';
const TOKEN = 'd_v_eKtlIQkXvQYKoo5aNObWQQR3Ou3scha5oBMp';
...
class UsuarisController {
    ...
    async createUsuari(nom, password) {
        const response = await fetch(`${this.apiUrl}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
